    ...
    <div className="relative h-full min-h-[720px] w-full px-8 xl:px-[min(2.1875vw,3.5rem)]">
      ...
      <div className="relative z-10 max-w-[70rem] pt-[clamp(80px,10vh,130px)] xl:max-w-[min(43.75vw,70rem)] xl:pt-[min(5.0781vw,130px)]">
        ...
        >
          <span
            aria-hidden="true"
            className="grid h-24 w-24 place-items-center rounded-full border border-[var(--color-black)] bg-[var(--color-lime)] text-3xl text-[var(--color-black)] shadow-[0_0_42px_var(--color-lime-glow)] transition-transform duration-300 group-hover:scale-105 max-[380px]:h-[42px] max-[380px]:w-[42px] max-[380px]:text-[15px] sm:h-28 sm:w-28 sm:text-4xl xl:h-[clamp(80px,7vw,176px)] xl:w-[clamp(80px,7vw,176px)] xl:text-[clamp(29px,2.4vw,62px)]"
          >
          ...
          <span className="text-[1.875rem] font-semibold text-[var(--color-text)] max-[380px]:text-[13.5px] sm:text-[2.125rem] xl:text-[clamp(1.875rem,1.875vw,3rem)]">
            {HERO.ctaLabel}
          </span>
        </a>
      </div>
