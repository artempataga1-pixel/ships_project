...
/* ВНИМАНИЕ: список валидируется на сервере — src/app/api/contact/route.ts
   ...
   Пилот (этап 0): title новой практики ДОБАВЛЕН к старым значениям, старые не
   тронуты — главная ещё живёт на старом наборе практик. Приведение списка к
   пяти новым практикам — шаг 1.5 плана. */
