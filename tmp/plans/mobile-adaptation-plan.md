...
|-----|--------|------|---------------------|
| 0 — Подготовка | ✅ | 2026-07-17 | Копия плана, доки прочитаны, 6 эталонных скриншотов, tsc чист, eslint — 2 старые ошибки в useStoryController.ts (не мои, зафиксированы как фон) |
| 1 — Нативный скролл | ⬜ | | |
| 2 — Нижнее меню + FAB | ⬜ | | |
| 3 — Медиа и перф | ⬜ | | |
| 4 — Секции | ⬜ | | |
