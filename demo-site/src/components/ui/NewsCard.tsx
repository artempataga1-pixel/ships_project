...
export function NewsCard({ news }: { news: NewsItem }) {
  return (
    <article className="news-card flex flex-col gap-3 p-6 rounded-lg transition-all duration-300" style={{ background: "var(--card-bg)", border: "1px solid var(--news-card-border)", boxShadow: "var(--news-card-shadow)" }}>
