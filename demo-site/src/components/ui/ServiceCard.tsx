...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <div className="group p-6 sm:p-8 rounded-lg transition-all duration-300" style={{ background: "var(--card-bg)", border: "1px solid var(--service-card-border)", boxShadow: "var(--service-card-shadow)" }}>
